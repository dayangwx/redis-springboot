			...
			<div class="right-alert-content-main" style="display: block;">
				<ul class="edit-ul">
					<li class="form-items">
						<!---<<<<  列表   >>>>-->
						<div class="form-left">
							<span><i class="iconfont icon-bitian"></i>用户实例：</span>
						</div>
						<div class="form-right">
				...
				<ul class="view-ul">
					...
					<div class="form-btns col-full" style="position: absolute; top: 350px; right: 75px;">
						<div id="alertBtn">
							<!-- <button type="button" class="TextBtn cancel">取消</button> -->
							<button class="TextBtn reset" type="button"
									onclick="resetAlert();">重置</button>
							...
							&emsp;
							<!-- <button type="button" id="batchAddDemo" class="TextBtn-import" onclick="downImpExample();" >示例</button> -->
							<div class="form-right" style="width: 75px;line-height:32px;left: 72%;">
								<button type="button" class="form-select-btn" style="border-radius: 4px;font-size: 14px;">示例</button>
								<ul class="form-select-menu">
									<li onclick="downImpExample('importDemo.csv');">CSV</li>
									<li onclick="downImpExample('importDemo.xls');">EXEL</li>
								</ul>
							</div>
						</div>
					</div>
					<li class="form-items" style="font-size:12px; color:#f56c6c;position: absolute; top: 418px; right: 160px;">
						温馨提示：导入支持CSV及EXEL;EXCEL仅支持xlsx和xls后缀文件!<br> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;导入数据列必须为用户实例！
					</li>
				</ul>
			</div>
		</div>
